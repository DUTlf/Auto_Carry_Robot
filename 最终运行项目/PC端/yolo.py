...
class YOLO(object):
    _defaults = {
        # "model_path"        : 'logs/Epoch50-Total_Loss11.6703-Val_Loss7.3870.pth',

        "model_path": './logs/Epoch100-Total_Loss3.5246-Val_Loss3.7538.pth',

        "anchors_path"      : 'model_data/yolo_anchors.txt',
        #"anchors_path"      : 'D:/Projects/Hardware/yolo3-pytorch/model_data/yolo_anchors.txt',
        "classes_path"      : 'model_data/coco_classes.txt',
        #"classes_path"      : 'D:/Projects/Hardware/yolo3-pytorch/model_data/yolo_anchors.txt',

        "model_image_size"  : (416, 416, 3),
        "confidence"        : 0.5, # 大于0.7才会认为是对应物体
        "iou"               : 0.3,
        "cuda"              : True,
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            myLabel.append(predicted_class)
            tempLoc = [top, left, bottom, right]
            myLoc.append(tempLoc)
